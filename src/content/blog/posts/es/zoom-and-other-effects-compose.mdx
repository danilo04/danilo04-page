...
![Tamaño de imagen versus tamaño del contenedor](/zoom-image-size.webp)
...
<div style={{ display: 'flex', justifyContent: 'center' }}>
  <img src="/media/touch-events-setup.GIF" alt="Demostración de configuración de eventos táctiles" width="400" style={{ display: 'block' }} />
</div>
