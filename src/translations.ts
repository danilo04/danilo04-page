  ...
  en: {
    ...
    home: {
      hero: {
        ...
        titleLine3: "Android Apps",
        description: "Android Engineer & PhD Researcher specializing in privacy, robust sync engines, and advanced encryption protocols.",
  ...
  es: {
    ...
    home: {
      hero: {
        ...
        titleLine2: "Android Seguras y de",
        titleLine3: "Alto Rendimiento",
        description: "Ingeniero Android e Investigador PhD especializado en privacidad, motores de sincronización robustos y protocolos de cifrado avanzados.",
